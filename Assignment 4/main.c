...
int checkForBlock(char*webs,int client){
	int r=0;
	...
	if (!connectWebsite){
		write(client,"<html><body><H1>Error 400 Bad Request: Invalid URL </H1></body></html>",strlen("<html><body><H1>Error 400 Bad Request: Invalid URL </H1></body></html>"));
           	perror("Inavlid host address");
           	r=-1;
	}
	else{	
